...
class Callbacks {
    private callbacks = new Map<(args: GpioEdgeEvent) => void, Map<number, pigpio.Event>>()
    put (edge: number, listener: (args: GpioEdgeEvent) => void, callback: pigpio.Event) {
    ...
    get (edge: number, listener: (args: GpioEdgeEvent) => void): pigpio.Event | undefined {
