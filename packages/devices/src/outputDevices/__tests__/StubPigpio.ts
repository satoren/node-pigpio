...
import { BBI2COption, BBSpiOption, Gpio, I2c, I2COption, Pigpio, Spi, SpiOption, GpioEdgeType, GpioEventArgsType, GpioMode,PullUpDownType } from "@node-pigpio/highlevel";
...
export class StubPigpio implements Pigpio{
    ...
    eventTrigger(event: 'EVENT0' | 'EVENT1' | 'EVENT2' | 'EVENT3' | 'EVENT4' | 'EVENT5' | 'EVENT6' | 'EVENT7' | 'EVENT8' | 'EVENT9' | 'EVENT10' | 'EVENT11' | 'EVENT12' | 'EVENT13' | 'EVENT14' | 'EVENT15' | 'EVENT16' | 'EVENT17' | 'EVENT18' | 'EVENT19' | 'EVENT20' | 'EVENT21' | 'EVENT22' | 'EVENT23' | 'EVENT24' | 'EVENT25' | 'EVENT26' | 'EVENT27' | 'EVENT28' | 'EVENT29' | 'EVENT30' | 'EVENT_BSC'): Promise<void> {
        throw new Error('Method not implemented.');
    }
